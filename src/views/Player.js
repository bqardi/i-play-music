...
function Player({ id }) {
	...
	return (
		<article
			className="Player"
			style={{
				backgroundImage: `url(${content.album?.images && content.album?.images[0].url})`
			}}
		>
			...
			<div className="Player__image">
				<div className="Player__imageOuter">
					<div className="Player__imageInner">
						<img
							className="Player__imageImg"
							src={content.album?.images && content.album?.images[0].url}
							alt={content.artists && content.artists[0]}
						/>
					</div>
				</div>
			</div>
